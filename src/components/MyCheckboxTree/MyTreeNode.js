...
export default class MyTreeNode extends React.Component{
    ...
    handleClick(ev, data, element) {
        console.log('boom');
        console.log('boom', data.action);
        data.me.props.onRMClick(ev,data,element);
    }
    ...
    render() {
        ...
        const me = this;
        var inner = this.renderInner();
        // color: '#222' , 
        // backgroundColor: '#ffffff',
        const activeStyle = { 
            border: '0px outset black',
        };
        var id='id' + this.props.label;
        return (
            <div>
                ...
                <ContextMenu id={id} stylex={activeStyle}>
                <MenuItem data={{action: 'add',me}} onClick={me.props.onRMClick}>
                    add
                </MenuItem>
                <MenuItem data={{action: 'delete',me}} onClick={me.props.onRMClick}>
                    delete
                </MenuItem>
                </ContextMenu> 
