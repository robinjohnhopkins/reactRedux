...
import NodeModel from 'react-checkbox-tree/src/js//NodeModel';
import TreeNode from './MyTreeNode';
import iconsShape from 'react-checkbox-tree/src/js//shapes/iconsShape';
import languageShape from 'react-checkbox-tree/src/js//shapes/languageShape';
import listShape from 'react-checkbox-tree/src/js//shapes/listShape';
import nodeShape from 'react-checkbox-tree/src/js//shapes/nodeShape';

class CheckboxTreeExt extends React.Component {
    static propTypes = {
    ...
    renderTreeNodes(nodes, parent = {}) {
        ...
        const { icons: defaultIcons } = CheckboxTreeExt.defaultProps;
...
export default CheckboxTreeExt;